...
public enum Zaehlertyp {
    BALGENGASZAEHLER, DREHKOLBENZAEHLER, DREHSTROMZAEHLER, ELEKTRONISCHER_ZAEHLER, INTELLIGENTES_MESSSYSTEM, LEISTUNGSZAEHLER, MAXIMUMZAEHLER, MODERNE_MESSEINRICHTUNG, TURBINENRADGASZAEHLER, ULTRASCHALLGASZAEHLER, WASSERZAEHLER, WECHSELSTROMZAEHLER, WIRBELGASZAEHLER;
    ...
    public String toValue() {
        switch (this) {
            ...
            case WASSERZAEHLER: return "WASSERZAEHLER";
    ...
    public static Zaehlertyp forValue(String value) throws IOException {
        ...
        if (value.equals("WASSERZAEHLER")) return WASSERZAEHLER;
