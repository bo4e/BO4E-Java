 ...
 */
public enum Typ {
    ANGEBOT, ANSPRECHPARTNER, AUSSCHREIBUNG, BUENDELVERTRAG, ENERGIEMENGE, FREMDKOSTEN, GERAET, GESCHAEFTSOBJEKT, GESCHAEFTSPARTNER, KOSTEN, LASTGANG, MARKTLOKATION, MARKTTEILNEHMER, MESSLOKATION, NETZNUTZUNGSRECHNUNG, PREISBLATT, PREISBLATTDIENSTLEISTUNG, PREISBLATTHARDWARE, PREISBLATTKONZESSIONSABGABE, PREISBLATTMESSUNG, PREISBLATTNETZNUTZUNG, PREISBLATTUMLAGEN, RECHNUNG, REGION, REGIONALTARIF, STANDORTEIGENSCHAFTEN, TARIF, TARIFINFO, TARIFKOSTEN, TARIFPREISBLATT, VERTRAG, ZAEHLER, ZEITREIHE;
    ...
    public static Typ forValue(String value) throws IOException {
        ...
        if (value.equals("ANSPRECHPARTNER")) return ANSPRECHPARTNER;
