...
* .. HINT::
* `Kontakt JSON Schema
* <https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.1.0-rc1/src/bo4e_schemas/com/Kontakt.json>`_
*/
@JsonInclude(JsonInclude.Include.NON_NULL)
public class Kontaktweg extends COM {
    private final ComTyp _typ = ComTyp.KONTAKTWEG;
